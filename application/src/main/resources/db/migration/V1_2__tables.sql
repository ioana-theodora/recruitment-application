...
create table CAN_CANDIDATE (ID bigint primary key, 
					 ...
					 CAN_ADDRESS_ID bigint not null,
					 CAN_CONTACT_ID bigint not null,
					 CAN_POSITION_ID bigint not null,
					 CAN_SKILL_ID bigint not null,
					 CAN_JOB_ID bigint not null,
					 CAN_STATUS_ID bigint not null,
					 CAN_CV_ID bigint not null,
